...
export const metadata = {
  title: "Heavy-Duty Degreasers for Factories & Plants | Neat Brand Trade",
  description:
    "Direct manufacturer of heavy-duty industrial degreasers and cleaning chemicals. We supply factories and warehouses across Ghana in bulk 25L to 1000L volumes.",
};

const products = [
  { icon: "⚙️", name: "Heavy-Duty Degreasers", desc: "Cuts through thick oil, grease, and industrial residues." },
  { icon: "🏭", name: "Floor Cleaners", desc: "Formulated for factory floors, workshops, and large warehouses." },
