...
export const metadata = {
  title: "Hospital & Clinical Disinfectants | Neat Brand Trade",
  description:
    "Hospital-grade surface disinfectants, hand sanitizers, and concentrated cleaning solutions for clinics and medical facilities in Ghana.",
};

const products = [
  { icon: "🧴", name: "Surface Disinfectants", desc: "Kills 99.9% of bacteria and viruses on clinical surfaces." },
  { icon: "🙌", name: "Medical Hand Sanitizers", desc: "High-alcohol formulations for wards and waiting areas." },
  { icon: "💨", name: "Spray Disinfectants", desc: "Fast-acting sanitization between patient visits." },
  { icon: "🪣", name: "Bulk Concentrates", desc: "Economical bulk solutions for large hospital facilities." },
];
    ...
    <>
      ...
      <section className="ind-hero">
        <div className="ind-left">
          <h1 className="ind-h1">Clinical protection for <em>Hospitals & Clinics</em></h1>
          <p className="ind-sub">
            Medical facilities require the highest standards of sanitation. We manufacture and supply hospital-grade disinfectants and sanitizers in bulk to keep your patients and staff safe.
          </p>
          <Link href="/disinfectants-ghana" className="ind-btn">
            Explore Medical Disinfectants →
          </Link>
        </div>
        ...
        <div className="ind-right">
          ...
          <Link href="/bulk-orders" style={{ color: '#0d7e6e', fontWeight: 600, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
            Request a Procurement Quote <span>→</span>
          </Link>
        </div>
      </section>
    </>
